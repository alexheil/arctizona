...
ActiveRecord::Schema.define(version: 20171213201408) do
  ...
  create_table "photographers", force: :cascade do |t|
    ...
    t.index ["unlock_token"], name: "index_photographers_on_unlock_token", unique: true
    t.index ["username"], name: "index_photographers_on_username", unique: true
  end
